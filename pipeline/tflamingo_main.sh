...
usage() {
    echo "Usage: $0 --code_dir <CODE_DIR> --data_path <DATA_PATH> --output_dir <OUTPUT_DIR> --chr_name <CHR_NAME> --assembly <ASSEMBLY> --low_resolution <LOW_RESOLUTION> --high_resolution <HIGH_RESOLUTION>" 
    exit 1
}
...
Rscript preprocess_pipeline.r $DATA_PATH $CHR_NAME $LOW_RESOLUTION $HIGH_RESOLUTION $ASSEMBLY ${OUTPUT_DIR}/preprocess
...
Rscript reconstruct_pipeline.r $OUTPUT_DIR $CHR_NAME $LOW_RESOLUTION $HIGH_RESOLUTIO
